...
def run_pca(session_id: str, columns: list[str] | None = None, n_components: int | None = None) -> dict:
...
def run_kmeans(session_id: str, columns: list[str] | None = None, n_clusters: int = 3) -> dict:
...
def detect_anomalies(session_id: str, columns: list[str] | None = None, contamination: float = 0.05) -> dict:
